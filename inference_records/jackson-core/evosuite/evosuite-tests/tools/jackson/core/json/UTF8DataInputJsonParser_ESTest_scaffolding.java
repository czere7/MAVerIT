...
public class UTF8DataInputJsonParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "tools.jackson.core.json.UTF8DataInputJsonParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UTF8DataInputJsonParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "tools.jackson.core.util.InternalJacksonUtil",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, UTF8DataInputJsonParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UTF8DataInputJsonParser_ESTest_scaffolding.class.getClassLoader()); 
