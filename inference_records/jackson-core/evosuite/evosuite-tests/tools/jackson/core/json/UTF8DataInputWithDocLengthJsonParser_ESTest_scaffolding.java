...
public class UTF8DataInputWithDocLengthJsonParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "tools.jackson.core.json.UTF8DataInputWithDocLengthJsonParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UTF8DataInputWithDocLengthJsonParser_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UTF8DataInputWithDocLengthJsonParser_ESTest_scaffolding.class.getClassLoader()); 
