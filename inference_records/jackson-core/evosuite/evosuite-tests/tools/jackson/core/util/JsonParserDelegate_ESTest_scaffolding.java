...
public class JsonParserDelegate_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "tools.jackson.core.util.JsonParserDelegate"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JsonParserDelegate_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "tools.jackson.core.json.PackageVersion",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("tools.jackson.core.type.ResolvedType", false, JsonParserDelegate_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("tools.jackson.core.type.TypeReference", false, JsonParserDelegate_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JsonParserDelegate_ESTest_scaffolding.class.getClassLoader()); 
