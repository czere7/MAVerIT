...
from utils import advance_to_next_class, persist_checkpoint, config, write_log, write_to_log_file
import os
...
def class_advancer_node(agent_state: "AgentState") -> dict:
    ...
    _write_metadata(agent_state.get("run_id"))
    if next_index == total:
